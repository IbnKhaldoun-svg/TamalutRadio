...
- [ ] **Physical re-test gate:** PENDING on Samsung S25 / Italian network. Confirm Radio Maria is absent; BBC Radio 1 and BBC Radio 2 now play without the red terminal error; BBC Radio 4 remains working; UK Previous/Next order and wrap remain correct; and shared playback/local Music regressions remain green.
